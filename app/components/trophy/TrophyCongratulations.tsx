...
import {getUnreadTrophies, markTrophyAsRead} from '../../redux/slices/trophiesSlice';
...
function CongratulationsCard({trophy, onClose, ...props}: CongratulationsCardProps) {
    ...
    return (
        <Animatable.View ref={animationRef} style={[appStyles.panel, styles.card]} animation="bounceIn" {...props}>
            <Text style={[appStyles.primaryText, styles.headerText]}>Trophy achieved!</Text>
            <View style={styles.imageBox}>
                <SimpleLineIcons name="trophy" size={100} color={theme.COLORS.THEME_FONT} style={styles.trophyIcon}/>
                <Feather name="check" size={100} color={theme.COLORS.THEME_FONT} style={styles.checkIcon}/>
            </View>
    ...
    return (
        <>
            ...
            <View style={{...styles.container}}>
                <CongratulationsCard trophy={trophies[0]} onClose={() => setAsRead(trophies[0])}/>
            </View>
        </>
    );
}
