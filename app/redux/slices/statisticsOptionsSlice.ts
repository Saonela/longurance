...
export const loadStatisticsOptions = createAsyncThunk('statisticsOptions/loadStatisticsOptions', async () => {
...
export const updateStatisticsOptions = createAsyncThunk(
    ...
    StorageService.saveStatisticsOptions(options as StatisticsOptions).then();
    return options;
});
...
const statisticsOptionsSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder.addCase(loadStatisticsOptions.fulfilled, (state: StatisticsOptions, action) => {
            if (state) {
...
export const getStatisticsOptions = (state): StatisticsOptions => state.statisticsOptions;
